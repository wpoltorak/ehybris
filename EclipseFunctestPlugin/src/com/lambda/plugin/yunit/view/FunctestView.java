...
public class FunctestView extends ViewPart {
    ...
    private class TestRunSessionListener implements IFunctestRunSessionListener {
        public void sessionAdded(final FunctestRunSession testRunSession) {
            if (getSite().getWorkbenchWindow() == YPlugin.getActiveWorkbenchWindow()) {
                final FunctestRunSession deactivatedSession = setActiveTestRunSession(testRunSession);
        ...
        public void sessionRemoved(final FunctestRunSession testRunSession) {
            if (testRunSession.equals(fTestRunSession)) {
                final List<FunctestRunSession> testRunSessions = YPlugin.getModel().getFunctestRunSessions();
    ...
    private class TestSessionListener implements ITestSessionListener {
        ...
        public void sessionEnded(final long elapsedTime) {
            ...
            final String msg = FunctestMessages.format(FunctestMessages.FunctestView_message_finish, keys);
        ...
        public void testStarted(final TestCaseElement testCaseElement) {
            ...
            final String status = FunctestMessages
                    .format(FunctestMessages.FunctestView_message_started, new String[] { className, method });
     ...
     */
    FunctestRunSession setActiveTestRunSession(final FunctestRunSession testRunSession) {
        /*
        ...
        final FunctestRunSession deactivatedSession = fTestRunSession;
    ...
    private void configureToolBar() {
        ...
        final MenuManager layoutSubMenu = new MenuManager(FunctestMessages.FunctestView_layout_menu);
    ...
    public void rerunTest(final String testId, final String className, final String testName, final String launchMode) {
        ...
        try {
            ...
            ErrorDialog.openError(getSite().getShell(), FunctestMessages.FunctestView_error_cannotrerun, e.getMessage(), e.getStatus());
        }
    }
