...
public class FunctestPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private class StackFilterContentProvider implements IStructuredContentProvider {
		...
		public void saveFilters() {
			...
			getPreferenceStore().setValue(FunctestPreferencesConstants.PREF_ACTIVE_STACK_FILTERS_LIST, pref);
			pref = FunctestPreferencesConstants.serializeList(inactive.toArray(new String[inactive.size()]));
			getPreferenceStore().setValue(FunctestPreferencesConstants.PREF_INACTIVE_STACK_FILTERS_LIST, pref);
		}
	...
	private void createStackFilterPreferences(Composite composite) {
		...
		fFilterViewerLabel.setText(FunctestMessages.JUnitPreferencePage_filter_label);
	...
	private void createStepFilterButtons(Composite container) {
		...
		fAddFilterButton.setText(FunctestMessages.JUnitPreferencePage_addfilterbutton_label);
		fAddFilterButton.setToolTipText(FunctestMessages.JUnitPreferencePage_addfilterbutton_tooltip);
		...
		fAddTypeButton.setText(FunctestMessages.JUnitPreferencePage_addtypebutton_label);
		fAddTypeButton.setToolTipText(FunctestMessages.JUnitPreferencePage_addtypebutton_tooltip);
		...
		fAddPackageButton.setText(FunctestMessages.JUnitPreferencePage_addpackagebutton_label);
		fAddPackageButton.setToolTipText(FunctestMessages.JUnitPreferencePage_addpackagebutton_tooltip);
		...
		fRemoveFilterButton.setText(FunctestMessages.JUnitPreferencePage_removefilterbutton_label);
		fRemoveFilterButton.setToolTipText(FunctestMessages.JUnitPreferencePage_removefilterbutton_tooltip);
		...
		fEnableAllButton.setText(FunctestMessages.JUnitPreferencePage_enableallbutton_label);
		fEnableAllButton.setToolTipText(FunctestMessages.JUnitPreferencePage_enableallbutton_tooltip);
		...
		fDisableAllButton.setText(FunctestMessages.JUnitPreferencePage_disableallbutton_label);
		fDisableAllButton.setToolTipText(FunctestMessages.JUnitPreferencePage_disableallbutton_tooltip);
	...
	private void validateChangeAndCleanup() {
		...
		// if it's invalid, beep and leave sitting in the editor
			...
			fEditorText.setText(FunctestMessages.JUnitPreferencePage_invalidstepfilterreturnescape);
	...
	private void addType() {
		...
		try {
			...
			String title = FunctestMessages.JUnitPreferencePage_addtypedialog_title;
			String message = FunctestMessages.JUnitPreferencePage_addtypedialog_error_message;
			ExceptionHandler.handle(jme, shell, title, message);
			return;
		}

		dialog.setTitle(FunctestMessages.JUnitPreferencePage_addtypedialog_title);
		dialog.setMessage(FunctestMessages.JUnitPreferencePage_addtypedialog_message);
	...
	private void addPackage() {
		...
		dialog.setTitle(FunctestMessages.JUnitPreferencePage_addpackagedialog_title);
		dialog.setMessage(FunctestMessages.JUnitPreferencePage_addpackagedialog_message);
	...
	protected List<String> createInactiveStackFiltersList() {
		String[] strings = FunctestPreferencePage.parseList(getPreferenceStore().getString(
				FunctestPreferencesConstants.PREF_INACTIVE_STACK_FILTERS_LIST));
