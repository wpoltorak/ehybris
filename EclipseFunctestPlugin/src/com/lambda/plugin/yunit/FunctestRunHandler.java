...
public class FunctestRunHandler extends DefaultHandler {
	...
	public FunctestRunHandler() {

	}

	public FunctestRunHandler(FunctestRunSession testRunSession) {
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		if (qName.equals(IXMLTags.NODE_TESTRUN)) {
			if (fTestRunSession == null) {
				...
				String tagProjects = attributes.getValue(FunctestLaunchConfigurationConstants.ATTR_TAG_PROJECTS);
				...
				fTestRunSession = new FunctestRunSession(name, javaProjects);
				// TODO: read counts?
			...
			if (fTestRunSession == null) {
				...
				fTestRunSession = new FunctestRunSession(name, null);
				fTestSuite = fTestRunSession.getTestRoot();
			}
