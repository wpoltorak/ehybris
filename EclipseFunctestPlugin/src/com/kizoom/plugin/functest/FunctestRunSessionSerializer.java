...
public class FunctestRunSessionSerializer implements XMLReader {
	 ...
	 */
	public FunctestRunSessionSerializer(FunctestRunSession testRunSession) {
	...
	private void handleTestRun() throws SAXException {
		...
		if (!projects.isEmpty()){
			FunctestLaunchConfigurationElements elems = new FunctestLaunchConfigurationElements(projects);
			addCDATA(atts, FunctestLaunchConfigurationConstants.ATTR_TAG_PROJECTS, elems.getProjectNames());
		}
