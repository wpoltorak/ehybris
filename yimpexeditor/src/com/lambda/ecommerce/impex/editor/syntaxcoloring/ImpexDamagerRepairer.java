...
public class ImpexDamagerRepairer extends DefaultDamagerRepairer implements IPresentationDamager, IPresentationRepairer {

    /** The document this object works on */
    protected ImpexDocument document;
    /** The default text attribute if non is returned as data by the current token */
    protected TextAttribute defaultTextAttribute;

    public ImpexDamagerRepairer(ITokenScanner scanner) {
        super(scanner);
    }
    ...
    public IRegion getDamageRegion(ITypedRegion partition, DocumentEvent event, boolean documentPartitioningChanged) {
        ...
        return document.getDamageRegion(event);
