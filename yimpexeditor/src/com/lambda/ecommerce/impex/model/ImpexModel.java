...
import com.lambda.ecommerce.impex.antlr.AntlrProblemTypeToSeverityMapper;
...
public class ImpexModel implements IImpexModel {
    ...
    public static final String IMPEXFILE_PROBLEM_MARKER = YImpex.ID + ".impexFileProblem"; //$NON-NLS-1$
    ...
    private void createMarkers(final List<ImpexProblem> problems) {
        final IPreferenceStore store = YImpex.getDefault().getPreferenceStore();
