...
public final class FunctestMessages extends NLS {

	private static final String BUNDLE_NAME = "com.kizoom.plugin.functest.FunctestMessages";//$NON-NLS-1$

	static {
		NLS.initializeMessages(BUNDLE_NAME, FunctestMessages.class);
	}
