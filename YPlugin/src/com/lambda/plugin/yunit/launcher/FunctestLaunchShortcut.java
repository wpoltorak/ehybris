...
import com.lambda.plugin.yunit.ui.FunctestDialog;
...
public class FunctestLaunchShortcut implements ILaunchShortcut2 {
    ...
    protected ILaunchConfigurationWorkingCopy createLaunchConfiguration(final List<IJavaElement> elements, final String server)
        ...
        final FunctestLaunchConfigurationElements lce = new FunctestLaunchConfigurationElements(elements);
    ...
    private String getServer() {
        final FunctestDialog functestDialog = new FunctestDialog(getShell());
        functestDialog.open();
    ...
    private void launch(final Object[] elements, final String mode, final String server) {
        try {
            final List<IJavaElement> elementsToLaunch = FunctestLaunchConfigurationUtils.filterElementsToLaunch(elements);
    ...
    protected String[] getAttributeNamesToCompare() {
        return new String[] { FunctestLaunchConfigurationConstants.ATTR_TEST_SERVER,
                FunctestLaunchConfigurationConstants.ATTR_TEST_CONTAINERS, FunctestLaunchConfigurationConstants.ATTR_PROJECT_NAMES,
                FunctestLaunchConfigurationConstants.ATTR_MAIN_TYPE_NAMES, FunctestLaunchConfigurationConstants.ATTR_TEST_METHOD_NAMES };
    }
