...
public final class YUnitMessages extends NLS {

	private static final String BUNDLE_NAME = "com.lambda.plugin.yunit.YUnitMessages";//$NON-NLS-1$

	static {
		NLS.initializeMessages(BUNDLE_NAME, YUnitMessages.class);
	}
