...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "impex"
    // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:43:1: impex : ( ( Ws | Comment ) ( LineBreak )? )* EOF -> ^( IMPEX ^( COMMENTS ( Comment )* ) ) ;
    public final impexParser.impex_return impex() throws RecognitionException {
        ...
        try {
            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:2: ( ( ( Ws | Comment ) ( LineBreak )? )* EOF -> ^( IMPEX ^( COMMENTS ( Comment )* ) ) )
            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:4: ( ( Ws | Comment ) ( LineBreak )? )* EOF
            {
            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:4: ( ( Ws | Comment ) ( LineBreak )? )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:5: ( Ws | Comment ) ( LineBreak )?
            	    {
            	    // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:5: ( Ws | Comment )
            	    int alt1=2;
            	    ...
            	    switch (alt1) {
            	        case 1 :
            	            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:6: Ws
            	            {
            	            Ws1=(Token)match(input,Ws,FOLLOW_Ws_in_impex142);  
            	            stream_Ws.add(Ws1);
            	            ...
            	            break;
            	        case 2 :
            	            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:11: Comment
            	            {
            	            Comment2=(Token)match(input,Comment,FOLLOW_Comment_in_impex146);  
            	    ...
            	    // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:22: ( LineBreak )?
            	    int alt2=2;
            	    ...
            	    switch (alt2) {
            	        case 1 :
            	            // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:22: LineBreak
            	            {
            	            LineBreak3=(Token)match(input,LineBreak,FOLLOW_LineBreak_in_impex151);  
            ...
            // 44:39: -> ^( IMPEX ^( COMMENTS ( Comment )* ) )
            {
                // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:42: ^( IMPEX ^( COMMENTS ( Comment )* ) )
                {
                ...
                // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:51: ^( COMMENTS ( Comment )* )
                {
                ...
                // /work/projects/yeclipse/ImpexAST/src/main/java/impex.g:44:62: ( Comment )*
    ...
    public static final BitSet FOLLOW_Ws_in_impex142 = new BitSet(new long[]{0x0000800080004000L});
    public static final BitSet FOLLOW_Comment_in_impex146 = new BitSet(new long[]{0x0000800080004000L});
    public static final BitSet FOLLOW_LineBreak_in_impex151 = new BitSet(new long[]{0x0000800000004000L});
