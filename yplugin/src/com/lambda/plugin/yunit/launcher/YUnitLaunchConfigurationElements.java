...
public class YUnitLaunchConfigurationElements {
	...
	public YUnitLaunchConfigurationElements(List<? extends IJavaElement> elements) {
		init(elements);
	}
		...
		for (IJavaElement element : elements) {
			...
			switch (element.getElementType()) {
				...
				case IJavaElement.PACKAGE_FRAGMENT:
					containerHandles.add(YUnitLaunchConfigurationUtils.toString(element));
					break;
				case IJavaElement.TYPE:
					mainTypeQualifiedNames.add(YUnitLaunchConfigurationUtils.toString(element));
					// don't replace, fix for binary inner types
					break;
				case IJavaElement.METHOD:
					methodNames.add(YUnitLaunchConfigurationUtils.toString(element));
					break;
				default:
