...
public class YUnitRunListenerAdapter implements ITestSessionListener {

	private final YUnitRunSession fSession;

	public YUnitRunListenerAdapter(YUnitRunSession session) {
		fSession = session;
	}
