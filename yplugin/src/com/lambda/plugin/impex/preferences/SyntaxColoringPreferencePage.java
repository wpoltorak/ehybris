...
public class SyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    private final String[][] fSyntaxColorListModel = new String[5][3];
    ...
    private void createComponents(final Composite parent) {
        ...
        fSyntaxForegroundColorEditor = new ColorFieldEditor("Color", "C&olor:", stylesComposite);
        // final Button foregroundColorButton = fSyntaxForegroundColorEditor.getButton();
        // fSyntaxForegroundColorEditor.fillIntoGrid(gd);
